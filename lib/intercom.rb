...
require 'intercom/service/ticket_type'
require 'intercom/service/ticket_type_attribute'
require 'intercom/service/ticket'
...
require 'intercom/ticket_type'
require 'intercom/ticket_type_attribute'
require 'intercom/ticket'
